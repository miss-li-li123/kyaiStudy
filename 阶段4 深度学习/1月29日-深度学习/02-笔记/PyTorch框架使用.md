...
![image-20260129201200237](img/image-20260129201200237.png)
...
![image-20260129210504931](img/image-20260129210504931.png)

![image-20260129211211616](img/image-20260129211211616.png)
...
> 在一个新的维度上连接一系列张量，这会增加一个新维度，并且所有输入张量的形状==必须完全相同==。
